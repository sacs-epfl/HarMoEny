...
harmony_batches=(3500 3500 2500 2500)
harmony_expert_cache_size=(1 2 4 8 16)
exflow_batches=(1500 1500 1250 1250)
fastmoe_batches=(1500 1500 1500 2250)
fastermoe_batches=(1500 1500 1500 2250)
deepspeed_batches=(1200 800 800 1000)
...
do
    python3 src/start_harmony.py \
        ...
        --expert_cache_size ${harmony_expert_cache_size[i]} \
