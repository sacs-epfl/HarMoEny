...
def plot_workload_duration_policy_vs_dataset():
    df = pd.read_csv(f"../data_processed/systems/skew/workload_duration_policy_vs_dataset.csv", index_col=0)
    ...
    save_plot(plt, "../figures/systems/skew/workload_duration_policy_vs_dataset.png")
