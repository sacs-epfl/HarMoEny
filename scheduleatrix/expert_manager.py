...
# OLD
# Creating topo for .cuda()
        # # Create basic initial topology of modulo assignment
        # self.initial_topology = [[] for _ in range(self.num_gpus)]
        ...
        #         self.initial_topology[i].append(j)
            
        #     start = end
        
        # # Load the created topology
        # self.load_cache(self.initial_topology)
...
# execute a single expert
        ...
        #     r = self.cached_experts[idx](data)
        #     return r

# cache loading
        # for slot_idx, expert_idx in enumerate(new_cache[self.rank]):
