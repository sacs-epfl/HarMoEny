...
do
    ...
    batch_size="${batch_sizes[$skew_index]}"
    num_sample="${num_samples[$skew_index]}"
    ...
    do
        python3 src/start_harmony.py \
                ...
                --pa "outputs/exp-qwen-policies-skew-ttft/$datetime/$skew-$policy"
    done
done
