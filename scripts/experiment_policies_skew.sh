num_samples=1000000
output_path="data/policies/skew/$(date +"%Y-%m-%d_%H-%M")"
seq_len=120
world_size=8
num_experts=128
...
deepspeed_batches=(1250 1100 625 550 450 400) # TODO
even_split_batches=(2500 2500 2500 2500 2500 2500)
drop_batches=(2500 2500 2500 2500 2500 2500)
